 {{-- <div wire:poll.9500ms class="nk-header nk-header-fixed nk-header-fluid is-light"> --}}
         ...
         <div class="container-fluid">
             <div class="nk-header-wrap">
                 ...
                 <div class="nk-header-search ms-3 ms-xl-0">
                     ...
                     <input type="text" wire:model="search" class="form-control border-transparent form-focus-none"
                 ...
                 <div class="nk-header-tools">
                     <ul class="nk-quick-nav">
                         ...
                         <li class="dropdown notification-dropdown">
                             <a href="#" class="dropdown-toggle nk-quick-nav-icon" data-bs-toggle="dropdown">
                                 <div
                                     class="icon-status  {{ Auth::user()->unreadNotifications->count() > 0 ? 'icon-status-info' : '' }}">
                             ...
                             <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end">
                                 ...
                                 <div class="dropdown-body">
                                     <div class="nk-notification">
                                         @foreach (Auth::user()->notifications->take($limitPerPage) as $item)
                                             @if ($item->type == 'App\Notifications\UserNotif')
                                                 <div class="nk-notification-item dropdown-inner {{ $item->read_at == null ? '' : 'bg-light' }}"
                                                     wire:click="markAsRead({{ $item }})">
