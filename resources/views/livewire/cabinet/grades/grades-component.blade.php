            ...
            <div class="nk-block-head nk-block-head-sm">
                <div class="nk-block-between g-3">
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">Grades List</h3>
               ...
               -->
                        <a href="{{ route('cabinet-grades-add') }}"
                            ...
                            <tbody>
                              @foreach ($grade as $item)
                                 <tr class="nk-tb-item"> 
                                    ...
                                    <td scope="row">
                                        <div>
                                            <a href="{{ route('cabinet-grades-show', $item->slug) }}">
                                                <div>
                                    ...
                                    <td>
                                        <ul class="nk-tb-actions gx-1">
                                            ...
                                            <li class="nk-tb-action-hidden">
                                                <a href="{{ route('cabinet-grades-edit', $item->slug) }}" class="btn btn-trigger btn-icon"
