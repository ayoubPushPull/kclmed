            ...
            <div class="nk-block-head nk-block-head-sm">
                <div class="nk-block-between g-3">
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">Medications List</h3>
                ...
                <a data-bs-toggle="modal" href="#addAppointment" class="btn btn-primary d-none d-md-inline-flex"><em class="icon ni ni-plus"></em><span>Add Request</span></a>
               -->
                        <a href="{{ route('cabinet-MedicationCabinets-add') }}"
                    ...
                    <div class="card-inner-group">
                        ...
                        <table class="table table-hover">
                            <thead>
                                ...
                                <th scope="col"><span>Forme</span></th>
                                <th scope="col"><span>Producing Company</span></th>
                            ...
                            <tbody>
                             @foreach ($medication as $item)
                                 <tr class="nk-tb-item"> 
                                    <td scope="row">
                                        <div>
                                          <a href="{{ route('cabinet-MedicationCabinets-show', $item->slug) }}">
                                                <div class="">
                                                    <img src="{{ asset('dashboard/assets/images/medicationCabinet/')}} / {{ $item->photo_medicament}}"
                                                    class="rounded-circle user-photo"  width="52" height="52">
                                                </div>
                                           </a> 
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <span>{{ $item->forme }}</span>
                                    </td>
                                    <td>
                                        <span class="tb-date">{{ $item->producing_company }}</span>
                                    </td>
                                    @if($item->status==0)
                                    <td>
                                    ...
                                    @endif
                                    <td>
                                        <span class="tb-date">{{ $item->active }}</span>
                                    </td>
                                    <td>
                                        <ul class="nk-tb-actions gx-1">
                                            ...
                                            <li class="nk-tb-action-hidden">
                                                <a href="{{ route('cabinet-MedicationCabinets-edit', $item->slug)}}" class="btn btn-trigger btn-icon"
