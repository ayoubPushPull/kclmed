            ...
            <div class="nk-block-head nk-block-head-sm">
                <div class="nk-block-between g-3">
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">Sessions List</h3>
                ...
                <a data-bs-toggle="modal" href="#addAppointment" class="btn btn-primary d-none d-md-inline-flex"><em class="icon ni ni-plus"></em><span>Add Patient</span></a>
               -->
                        <a href="{{ route('cabinet-sessions-add') }}"
                ...
                <div class="card card-bordered card-stretch">
                    <div class="card-inner-group">
                        ...
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                <th scope="col"><span>Seance</span></th>
                                <th scope="col"><span>Patient</span></th>
                                <th scope="col"><span>Acte</span></th>
                                <th scope="col"><span>Prix</span></th>
                                <th scope="col"><span>Is pay</span></th>
                         ...
                         @foreach ($seance as $item)
                                 <tr class="nk-tb-item"> 
                                    ...
                                    <td scope="row">
                                        <div>
                                            <a href="{{ route('cabinet-sessions-show', $item->slug) }}">
                                                <div>
                                                    <span>{{ $item->num_seance}}</span>
                                                </div>
                                            </a>
                                        </div>
                                    </td>
                                    <td>
                                        <a href="{{ route('cabinet-sessions-show', $item->slug) }}">
                                            <span class="tb-lead-sub">
                                                {{ $item->patient->fname }} {{ $item->patient->lname}}</span>
                                        </a>
                                    </td>

                                    <td>
                                        <span>{{ $item->acte_seance}}</span>
                                    </td>
                                    <td>
                                        <span>{{ $item->prix_total}}</span>
                                    </td>
                                    <td>
                                        <span class="tb-date">{{ $item->is_pay }}</span>
                                    </td>
                                    <td>
                                        <ul class="nk-tb-actions gx-1">
                                            ...
                                            <li class="nk-tb-action-hidden">
                                                <a href="{{route('cabinet-sessions-edit', $item->slug)}}" class="btn btn-trigger btn-icon"
