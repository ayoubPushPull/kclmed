    ...
    <div class="nk-content-inner">
        <div class="nk-content-body">
            <div class="nk-block-head nk-block-head-sm">
               ...
               -->
                        <a href="{{ route('cabinet-medicationcategories-add') }}"
                            ...
                            <tbody>
                              @foreach ($medcategorie as $item)
                                 <tr class="nk-tb-item"> 
                                    <td scope="row">
                                        <div>
                                            <a href="{{ route('cabinet-medicationcategories-show', $item->slug) }}">
                                                <div >
                                                    <span>{{$item->name }}</span>
                                                </div>
                                            </a>
                                    ...
                                    <td>
                                        <ul class="nk-tb-actions gx-1">
                                            ...
                                            <li class="nk-tb-action-hidden">
                                                <a href="{{route('cabinet-medicationcategories-edit' , $item->slug) }}" class="btn btn-trigger btn-icon"
