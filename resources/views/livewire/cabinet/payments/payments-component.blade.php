            ...
            <div class="nk-block-head nk-block-head-sm">
                <div class="nk-block-between g-3">
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">Payments List</h3>
               ...
               -->
                        <a href="{{ route('cabinet-payments-add') }}"
                    ...
                    <div class="card-inner-group">
                        ...
                        <table class="table table-hover">
                            <thead>
                                ...
                                <th scope="col"><span>Prix Payé</span></th>
                                <th scope="col"><span>Prix Reste</span></th>
                       ...
                       @foreach ($payment as $item)
                            <tbody>
                                 <tr class="nk-tb-item"> 
                                    ...
                                    <td scope="row">
                                        <div>
                                            <a href="{{ route('cabinet-payments-show', $item->slug) }}">
                                                <div >
                                                    <span>{{$item->seance->acte_seance}}</span>
                                                </div>
                                            </a>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <span>{{ $item->prix_payé }}</span>
                                    </td>
                                    <td>
                                        <span>{{ $item->prix_reste }}</span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <ul class="nk-tb-actions gx-1">
                                            ...
                                            <li class="nk-tb-action-hidden">
                                                <a href="{{route('cabinet-payments-edit' , $item->slug)}}" class="btn btn-trigger btn-icon"
