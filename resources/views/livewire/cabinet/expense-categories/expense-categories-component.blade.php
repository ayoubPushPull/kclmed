            ...
            <div class="nk-block-head nk-block-head-sm">
                <div class="nk-block-between g-3">
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">Expense Category List</h3>
               ...
               -->
                        <a href="{{ route('cabinet-expensecategories-add') }}"
                            class="btn btn-primary d-none d-md-inline-flex"></em><span>Add
                            Expense Category</span></a>
                ...
                <div class="card card-bordered card-stretch">
                    <div class="card-inner-group">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                            @foreach ($expcategorie as $item)
                                 <tr class="nk-tb-item"> 
                                    <td scope="row" >
                                        <div>
                                            <a href="{{ route('cabinet-expensecategories-show', $item->slug) }}">
                                                <div >
                                    ...
                                    <td>
                                        <ul class="nk-tb-actions gx-1">
                                            ...
                                            <li class="nk-tb-action-hidden">
                                                <a href="{{route('cabinet-expensecategories-edit' , $item->slug)}}" class="btn btn-trigger btn-icon"
