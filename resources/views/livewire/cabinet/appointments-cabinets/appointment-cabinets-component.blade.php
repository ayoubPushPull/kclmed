             ...
             <div class="nk-block-head nk-block-head-sm">
                 <div class="nk-block-between g-3">
                     <div class="nk-block-head-content">
                         <h3 class="nk-block-title page-title">Appointments List</h3>
                     ...
                     <div class="nk-block-head-content">
                         <!--- <a data-bs-toggle="modal" href="{{ route('cabinet-AppointmentCabinets-add') }}" class="btn btn-icon btn-primary d-md-none"><em class="icon ni ni-plus"></em></a>
            <a data-bs-toggle="modal" href="{{ route('cabinet-AppointmentCabinets-add') }} class="btn btn-primary d-none d-md-inline-flex"><em class="icon ni ni-plus"></em><span>Add Appointment</span></a>
               -->
                         <a href="{{ route('cabinet-AppointmentCabinets-add') }}"
                         ...
                         <table class="table table-hover">
                             <thead>
                                 <tr>
                                     ...
                                     <th scope="col"><span>Patient Name</span></th>
                             ...
                             <tbody>
                                 @foreach ($appoitment as $item)
                                     <tr class="nk-tb-item">
                                         <td scope="row">
                                             <a href="{{ route('cabinet-AppointmentCabinets-show', $item->slug) }}">
                                         ...
                                         <td>
                                             <span>{{ $item->patient->fname }}{{$item->patient->lname}}</span>
                                         </td>
                                         @if($item->status==0)
                                         <td>
                                         ...
                                         @endif
                                            <td>  <a href="#"
                                                  wire:click.prevent="changeStatus({{ $item->id }})"
                                                   ...
                                                   class="{{ $item->status == 0 ? 'icon ni ni-toggle-off' : 'icon ni ni-toggle-on' }}"></a>
                                         </td>
                                         <td class="nk-tb-col nk-tb-col-tools">
                                             <ul class="nk-tb-actions gx-1">
                                                 ...
                                                 <li class="nk-tb-action-hidden">
                                                     <a href="{{ route('cabinet-AppointmentCabinets-edit', $item->slug) }}"
                                                         class="btn btn-trigger btn-icon" data-bs-toggle="tooltip"
