            ...
            <div class="nk-block-head nk-block-head-sm">
                <div class="nk-block-between g-3">
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">Arrangements List</h3>
                ...
                <a data-bs-toggle="modal" href="#addAppointment" class="btn btn-primary d-none d-md-inline-flex"><em class="icon ni ni-plus"></em><span>Add Arrangement</span></a>
               -->
                        <a href="{{ route('cabinet-arrangements-add') }}"
                            ...
                            <tbody>
                                @foreach ($arrangement as $item)
                                    <tr class="nk-tb-item">
                                        <td scope="row">
                                            <div>
                                                <a href="{{ route('cabinet-arrangements-show', $item->slug) }}">
                                        ...
                                        <td>
                                            <ul class="nk-tb-actions gx-1">
                                                ...
                                                <li class="nk-tb-action-hidden">
                                                    <a href="{{ route('cabinet-arrangements-edit', $item->slug) }}"
                                                        class="btn btn-trigger btn-icon" data-bs-toggle="tooltip"
