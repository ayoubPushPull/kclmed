    ...
    <div class="nk-content-inner">
        <div class="nk-content-body">
            <div class="nk-block-head nk-block-head-sm">
               ...
               -->
                        <a href="{{ route('cabinet-patients-add') }}"
                                    ...
                                    <div class="col-sm-12 col-lg-4 col-xxl-3">
                                        <div class="card card-bordered">
                                            <div class="card-inner">
                                                        ...
                                                        <div class="drodown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                             <ul class="nk-tb-actions gx-4">
                                                                    <li><a href="{{ route('cabinet-patients-show', $item->slug) }} "
                                                                            class="btn btn-trigger btn-icon" data-bs-toggle="tooltip"
                                                                            data-bs-placement="center" title="Quick View">
                                                                            <em class="icon ni ni-eye-fill"></em>
                                                                            </a></li>
                                                                     <li><a href="{{route('cabinet-patients-edit', $item->slug)}}" class="btn btn-trigger btn-icon"
                                              ...
                                              <div>
                                            <a href="{{ route('cabinet-patients-show', $item->slug) }}">
                                                <div class="user-avatar lg bg-primary">
                                                    <span>{{ substr($item->fname, 0, 1) }}</span>
                                                </div>
                                            </a></div>
                                                        <div class="user-info">
                                                            <h6><a href="{{ route('cabinet-patients-show', $item->slug) }}">
                                         ...
                                         @endif
                                                    ...
                                                    <ul class="team-info">
                                                        ...
                                                        <li><span>Phone</span><span>{{ $item->phone }}</li>
                                                        <li><span>Date Brith</span><span>{{ $item->date_birth}}</span></li>
                                                    </ul>
                                                    <div class="team-view">
                                                        <a href="{{ route('cabinet-patients-show', $item->slug) }}" class="btn btn-block btn-dim btn-primary"><span>View Profile</span></a>
                                                    </div>
                                                </div><!-- .team -->
                                            </div><!-- .card-inner -->
                                        </div><!-- .card -->
