    ...
    <div class="nk-content-inner">
        <div class="nk-content-body">
            <div class="nk-block-head nk-block-head-sm">
                ...
                <a data-bs-toggle="modal" href="#addAppointment" class="btn btn-primary d-none d-md-inline-flex"><em class="icon ni ni-plus"></em><span>Add Expense</span></a>
               -->
                        <a href="{{ route('cabinet-expenses-add') }}"
                ...
                <div class="card card-bordered card-stretch">
                    <div class="card-inner-group">
                        ...
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                <th scope="col"><span>Reference</span></th>
                                <th scope="col"><span>Name</span></th>
                                <th scope="col"><span>Amount</span></th>
                                <th scope="col"><span>Categorie Name</span></th>
                            ...
                            @foreach ($expense as $item)
                                 <tr class="nk-tb-item"> 
                                    ...
                                    <td>
                                        <a href="{{ route('cabinet-expenses-show', $item->slug) }}">
                                    ...
                                    <td>
                                        <span>{{ $item->categorie_expense->name }}</span>
                                    </td>
                                    @if($item->status==0)
                                         <td>
                                    ...
                                    <td>
                                        <ul class="nk-tb-actions gx-1">
                                            ...
                                            <li class="nk-tb-action-hidden">
                                                <a href="{{route('cabinet-expenses-edit', $item->slug)}}" class="btn btn-trigger btn-icon"
