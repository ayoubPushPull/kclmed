<div>
    ...
    <section class="page-header-section post-title style-1"
        style="background-image:  url({{ asset('landing/assets/images/banner/1.jpg') }});">
   ...
   <!-- <section class="feature-section padding-tb bg-color">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                            <div class="lab-item feature-item wow fadeInLeft" data-wow-delay=".2s"
                                ...
                                <div class="lab-inner">
                                    <div class="lab-thumb">
                                        <img src="{{ asset('landing/assets/images/feature/1.png') }}" alt="feature img">
                                    </div>
                                    <div class="lab-content">
                                        <h4>Assistance</h4>
                                        <p> Elle est disponible tous les jours de la semaine du lundi au vendredi et le
                                            samedi matin.
                                            Téléphone: +212 625 214 562
                                        </p>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                            <div class="lab-item feature-item wow fadeInUp" data-wow-delay=".2s" data-wow-duration="1s">
                                <div class="lab-inner">
                                    <div class="lab-thumb">
                                        <img src="{{ asset('landing/assets/images/feature/2.png') }}" alt="feature img">
                                    </div>
                                    <div class="lab-content">
                                        <h4>
                                            Insstalation</h4>
                                        <p>L’installation et le paramétrage de votre logiciel est entièrement réalisé
                                            par notre équipe technique Cette installation peut être doublé d’un
                                            accompagnement
                                        </p>
                                       <a href="#" class=""><span>Read More <i
                                                    class="icofont-rounded-double-right"></i></span></a>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                            <div class="lab-item feature-item wow fadeInUp" data-wow-delay=".2s" data-wow-duration="1s">
                                <div class="lab-inner">
                                    <div class="lab-thumb">
                                        <img src="{{ asset('landing/assets/images/feature/3.png') }}" alt="feature img">
                                    </div>
                                    <div class="lab-content">
                                        <h4>
                                            Mise a Jour</h4>
                                        <p>Les mises à jour et les sauvegardes se font automatiquement sur votre
                                            logiciel et sont incluses . Vous serez averti par mail lorsqu’une mise à
                                            jour effectuée.
                                        </p>
                                      <a href="#" class=""><span>Read More <i
                                                    class="icofont-rounded-double-right"></i></span></a>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                          <div class="lab-item feature-item wow fadeInRight" data-wow-delay=".2s"
                              ...
                              <div class="lab-inner">
                                    <div class="lab-thumb">
                                        <img src="{{ asset('landing/assets/images/feature/4.png') }}" alt="feature img">
                                    </div>
                                    <div class="lab-content">
                ...
                <div class="row flex-row-reverse">
                    <div class="col-lg-6 col-12">
                        <div class="about-thumb">
                            <img src="{{asset('landing/assets/images/about/01.jpg')}}" alt="about" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-lg-6 col-12">
        ...
        <div class="container">
            <div class="section-wrapper">
                <div class="counter-item wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".1s">
                    <div class="counter-item-inner">
                        <div class="counter-thumb">
                            <img src="{{asset('landing/assets/images/counter/01.png')}}" alt="counter">
                        </div>
                ...
                <div class="counter-item wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".2s">
                    <div class="counter-item-inner">
                        <div class="counter-thumb">
                            <img src="{{asset('landing/assets/images/counter/02.png')}}" alt="counter">
                        </div>
                        <div class="counter-content">
                ...
                <div class="counter-item wow fadeInRight" data-wow-duration="1s" data-wow-delay=".3s">
                    <div class="counter-item-inner">
                        <div class="counter-thumb">
                            <img src="{{asset('landing/assets/images/counter/03.png')}}" alt="counter">
                        </div>
                        <div class="counter-content">
                ...
                <div class="counter-item wow fadeInRight" data-wow-duration="1s" data-wow-delay=".4s">
                    <div class="counter-item-inner">
                        <div class="counter-thumb">
                            <img src="{{asset('landing/assets/images/counter/04.png')}}" alt="counter">
                        </div>
                        <div class="counter-content">
    ...
    <section class="doctor-section style-1 padding-tb pt-lg-110">
        <div class="container">
            <div class="doctor-header d-md-flex justify-content-between align-items-end wow fadeInUp"
                data-wow-duration="1s" data-wow-delay=".1s">
                <div class="doctor-header-title">
                    <h2><span>Meet Our</span></h2>
                    <h2>Professional Doctors</h2>
                </div>
                <div class="doctor-btn text-center wow fadeInUp d-none d-md-inline-block" data-wow-duration="1s"
                    data-wow-delay=".5s">
            ...
            <div class="section-wrapper">
                <div class="row justify-content-center">
                        ...
                        <div class="doctor-item style-1 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s">
                            <div class="doctor-inner">
                                <div class="doctor-thumb">
                                    <img src="{{asset('landing/assets/images/team/01.jpg')}}" alt="doctor">
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                        <div class="doctor-item style-1 active wow fadeInUp" data-wow-duration="1s"
                            data-wow-delay=".2s">
                            <div class="doctor-inner">
                                <div class="doctor-thumb">
                                    <img src="{{asset('landing/assets/images/team/02.jpg')}}" alt="doctor">
                                </div>
                                <div class="doctor-content">
                                    <div class="doctor-name">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                        <div class="doctor-item style-1 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                            <div class="doctor-inner">
                                <div class="doctor-thumb">
                                    <img src="{{asset('landing/assets/images/team/03.jpg')}}" alt="doctor">
                                </div>
                                <div class="doctor-content">
                                    <div class="doctor-name">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                        <div class="doctor-item style-1 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">
                            <div class="doctor-inner">
                                <div class="doctor-thumb">
                                    <img src="{{asset('landing/assets/images/team/04.jpg')}}" alt="doctor">
                                </div>
                                <div class="doctor-content">
                                    <div class="doctor-name">
                    ...
                    <div class="doctor-btn text-center wow fadeInUp d-md-none" data-wow-duration="1s"
                        data-wow-delay=".5s">
                        <a href="#" class="lab-btn"><span> view all doctors <i
                                    class="icofont-rounded-double-right"></i></span></a>
                    </div>
            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="certificate-content">
                        <h2><span>À propos de nous MYMED </span></h2>
                       <!-- <h2>Of Our Professional Doctors</h2>-->
                        <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec euismod euismod enim sit amet luctus. Vivamus pretium lorem at posuere facilisis. Sed est tortor, finibus et neque ut, tempus porttitor velit. Ut venenatis condimentum nisi, ultrices dignissim dui tincidunt sit amet. Donec laoreet.
                        ...
                        <a href="#" class="lab-btn"><span>S'inscrire Maintenant<i
                            ...
                            <div class="col-12 col-sm-6 col-md-6">
                                <div class="certificate-item-inner">
                                    <div class="certificate-thumb">
                                        <img src="{{asset('landing/assets/images/certificat/01.jpg')}}" alt="certificat">
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-md-6">
                                <div class="certificate-item-inner">
                                    <div class="certificate-thumb">
                                        <img src="{{asset('landing/assets/images/certificat/02.jpg')}}" alt="certificat">
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-md-6">
                                <div class="certificate-item-inner">
                                    <div class="certificate-thumb">
                                        <img src="{{asset('landing/assets/images/certificat/03.jpg')}}" alt="certificat">
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-md-6">
                                <div class="certificate-item-inner">
                                    <div class="certificate-thumb">
                                        <img src="{{asset('landing/assets/images/certificat/04.jpg')}}" alt="certificat">
                                    </div>
                                </div>
                            </div>
                        </div>
