            ...
            <div class="nk-block-head nk-block-head-sm">
                <div class="nk-block-between g-3">
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">Doctors Offices List</h3>
                ...
                <a data-bs-toggle="modal" href="#addAppointment" class="btn btn-primary d-none d-md-inline-flex"><em class="icon ni ni-plus"></em><span>Add Doctor Office</span></a>
               -->
                        <a href="{{ route('admin-doctoroffices-add') }}"
                            class="btn btn-primary d-none d-md-inline-flex"></em><span>Add
                            Doctor Office</span></a>
                ...
                <div class="card card-bordered card-stretch">
                    <div class="card-inner-group">
                        ...
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                <th scope="col"><span>Name Cabinet</span></th>
                                <th scope="col"><span>Email Cabinet</span></th>
                                <th scope="col"><span>Phone Cabinet</span></th>
                                <th scope="col"><span>Address Cabinet </span></th>
                                <th scope="col"><span>Rdv Min</span></th>
                            ...
                            <tbody>
                             @foreach ($doctoroffices as $item)
                                 <tr class="nk-tb-item"> 
                                    <td scope="row">
                                        <a href="{{ route('admin-doctoroffices-show', $item->slug) }}">
                                            <span class="tb-lead-sub">
                                          {{ $item->name_cabinet}}</span>
                                        </a>
                                    </td>
                                    <td>
                                        <a href="{{ route('admin-doctoroffices-show', $item->slug) }}">
                                            <span class="tb-lead-sub">
                                          {{ $item->email_cabinet}}</span>
                                        </a>
                                    </td>

                                    <td>
                                        <span>{{ $item->phone_cabinet }}</span>
                                    </td>
                                    <td>
                                        <span>{{ $item->address_cabinet }}</span>
                                    </td>
                                    <td>
                                        <span class="tb-date">{{ $item->rdv_min }}</span>
                                    </td>
                                    @if( $item->status==0 )
                                    <td>
                                    ...
                                    <td wire:click.prevent="changeStatus({{ $item->id }})"
                                        title="{{ $item->status == 0 ? 'incative' : 'active' }}"><i
                                        class="{{ $item->status == 0 ? 'icon ni ni-toggle-off text-primary ' : 'icon ni ni-toggle-on text-danger' }}" style="font-size:30px" >
                              </td> 
                                    <td>
                                        <ul class="nk-tb-actions gx-1">
                                            ...
                                            <li class="nk-tb-action-hidden">
                                                <a  href="{{ route('admin-doctoroffices-edit', $item->slug) }} " class="btn btn-trigger btn-icon"
                                                ...
                                                <div class="drodown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <ul class="link-list-opt no-bdr">
                                                            <li><a data-bs-toggle="modal" href="#editAppointment"><em
