            ...
            <div class="nk-block-head nk-block-head-sm">
                <div class="nk-block-between g-3">
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">Medical Background Category List</h3>
                                ...
                                @foreach ($medicalbackgroundcategory as $item)
                                    <tr class="nk-tb-item">
                                        <td scope="row">
                                            <div>
                                                <a
                                                    href="{{ route('cabinet-medicationcategories-show', $item->slug) }}">
                                                    <div>
                                                        <span>{{ $item->name }}</span>
                                                    </div>
                                                </a>
                                        ...
                                        <td>
                                            <ul class="nk-tb-actions gx-1">
                                                <li class="nk-tb-action-hidden">
                                                    <a href="{{ route('admin-medicalbackgroundcategory-show', $item->slug) }} "
                                                ...
                                                <li class="nk-tb-action-hidden">
                                                    <a href="{{ route('admin-medicalbackgroundcategory-edit', $item->slug) }} " class="btn btn-trigger btn-icon"
                                                ...
                                                <li>
                                                    <div class="drodown">
                                                        <a href="{{ route('admin-medicalbackgroundcategory-edit', $item->slug) }}"
