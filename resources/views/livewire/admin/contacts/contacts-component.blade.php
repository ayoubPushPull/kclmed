            ...
            <div class="nk-block-head nk-block-head-sm">
                <div class="nk-block-between g-3">
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">Contacts List</h3>
                ...
                <a data-bs-toggle="modal" href="#addAppointment" class="btn btn-primary d-none d-md-inline-flex"><em class="icon ni ni-plus"></em><span>Add Request</span></a>
                        ...
                        <a href="{{ route('admin-Contacts-add') }}"
                                        ...
                                        <td class="nk-tb-col nk-tb-col-tools">
                                            <ul class="nk-tb-actions gx-1">
                                                <li class="nk-tb-action-hidden">
                                                    <a href="{{ route('admin-Contacts-show', $item->slug) }} "
                                                ...
                                                <li class="nk-tb-action-hidden">
                                                    <a href="{{ route('admin-Contacts-edit', $item->slug) }} " class="btn btn-trigger btn-icon"
