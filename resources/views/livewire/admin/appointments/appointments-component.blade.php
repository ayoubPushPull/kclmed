                    ...
                    <div class="card-inner-group">
                        ...
                        <table class="table table-hover">
                            <thead>
                                ...
                                <th scope="col"><span>Statue</span></th>
                            ...
                            <tbody> 
                                 ...
                                 <tr class="nk-tb-item"> 
                                    ...
                                    <td>
                                        <a href="{{ route('admin-Appointments-show', $item->slug) }}">
                                            <span >
                                               {{ $item->name }}</span>
                                        </a>
                                    </td>
                                    ...
                                    <td class="nk-tb-col nk-tb-col-tools">
                                        <ul class="nk-tb-actions gx-1">
                                            ...
                                            <li class="nk-tb-action-hidden">
                                                <a href="{{ route('admin-Appointments-edit', $item->slug) }} " class="btn btn-trigger btn-icon"
