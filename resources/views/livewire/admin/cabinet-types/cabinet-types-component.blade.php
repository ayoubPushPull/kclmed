<div>
                ...
                <div class="modal-body modal-body-lg text-center">
                    <div class="nk-modal">
                        ...
                        <div class="nk-modal-text">
                            <p class="lead">are you sure to delete this type !</p>
                        </div>
    ...
    <div class="modal fade" tabindex="-1" id="addtype" wire:ignore.self>
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Add Type Cabinet</h5>
                </div>
            ...
            <div class="nk-block-head nk-block-head-sm">
                <div class="nk-block-between g-3">
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">Cabinet Types List</h3>
                ...
                <a data-bs-toggle="modal" href="#addAppointment" class="btn btn-primary d-none d-md-inline-flex"><em class="icon ni ni-plus"></em><span>Add Cabinet Types</span></a>
               -->
                        <a data-bs-toggle="modal" data-bs-target="#addtype"
                                        ...
                                        <td class="nk-tb-col nk-tb-col-tools">
                                            <ul class="nk-tb-actions gx-1">
                                                <li class="nk-tb-action-hidden">
                                                    <a href="{{ route('admin-cabinettypes-show', $item->slug) }} "
                                                ...
                                                <li class="nk-tb-action-hidden">
                                                    <a href="{{ route('admin-cabinettypes-edit', $item->slug) }} " class="btn btn-trigger btn-icon"
