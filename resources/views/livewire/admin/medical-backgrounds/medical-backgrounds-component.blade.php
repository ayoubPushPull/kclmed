            ...
            <div class="nk-block-head nk-block-head-sm">
                <div class="nk-block-between g-3">
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">Medical Background List</h3>
               ...
               -->
                        <a href="{{ route('admin-medicalbackgrounds-add') }}"
                            class="btn btn-primary d-none d-md-inline-flex"></em><span>Add
                                Medical Background </span></a>
                    ...
                    <div class="card-inner-group">
                        ...
                        <table class="table table-hover">
                            <thead>
                                ...
                                <th scope="col"><span>Name Medical Background </span></th>
                                <th scope="col"><span>Category Name</span></th>
                            ...
                            <tbody> 
                                 @foreach ($medicalbackgrounds as $item)
                                 <tr class="nk-tb-item"> 
                                   ...
                                   <td>
                                            ...
                                            <span >
                                                {{ $item->medicalBackgroundCat->name}} </span>
                                    ...
                                    <td class="nk-tb-col nk-tb-col-tools">
                                        <ul class="nk-tb-actions gx-1">
                                            <li class="nk-tb-action-hidden">
                                                <a href="{{ route('admin-medicalbackgrounds-show', $item->slug) }} "
                                            ...
                                            <li class="nk-tb-action-hidden">
                                                <a href="{{ route('admin-medicalbackgrounds-edit', $item->slug) }} " class="btn btn-trigger btn-icon"
