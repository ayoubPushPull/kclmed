    ...
    <div class="nk-content-inner">
        <div class="nk-content-body">
            <div class="nk-block-head nk-block-head-sm">
                ...
                <a data-bs-toggle="modal" href="#addAppointment" class="btn btn-primary d-none d-md-inline-flex"><em class="icon ni ni-plus"></em><span>Add User</span></a>
               -->
                            ...
                            <div class="card-title-group">
                                ...
                                <div class="card-tools me-n1">
                                    <ul class="btn-toolbar gx-1">
                                        <li> 
                                          {{--    <a wire:model="searchTerm" class="btn btn-icon search-toggle toggle-search"
                        ...
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col"><span>Email Adresse</span></th>
                                    <th scope="col"><span>Phone</span></th>
                                    <th scope="col"><span>Role</span></th>
                                    <th scope="col"><span>Has Account</span></th>
                            ...
                            <tbody>
                                @foreach ($users as $item)
                                    <tr class="nk-tb-item">
                                        <td>
                                            <div>
                                                <a href="{{ route('admin-user-show', $item->slug) }}">
                                        ...
                                        <td>
                                            <a href="{{ route('admin-user-show', $item->slug) }}">
                                                <span class="tb-lead-sub">
                                                    {{ $item->personal->lname }}</span>
                                            </a>
                                        </td>
                                        <td>
                                            <span>{{ $item->personal->email_personel }}</span>
                                        </td>
                                        <td>
                                            <span>{{ $item->personal->phone_personel }}</span>
                                        </td>
                                        <td>
                                            <span class="tb-date">{{ $item->role->name }}</span>
                                        </td>
                                     
                                      
 

                                        @if( $item->personal->has_account==1)
                                        <td>
                                        ...
                                        <td class="nk-tb-col nk-tb-col-tools">
                                            <ul class="nk-tb-actions gx-1">
                                                ...
                                                <li class="nk-tb-action-hidden">
                                                    ...
                                                    <a href="{{ route('admin-settings', $item->slug) }}" class="btn btn-trigger btn-icon"
